...
Equations
	...
	coverage 	defining constraints on the coverage;
	...
	coverage(Queries) .. 	smax((Qcs), fraction(Queries,Qcs)*z(Qcs)) =g= y(Queries);

Model blinkdb /all/;

Solve blinkdb using MINLP maximizing obj ;

Display blinkdb.modelstat, blinkdb.solvestat, z.l, z.m, y.l , y.m ;

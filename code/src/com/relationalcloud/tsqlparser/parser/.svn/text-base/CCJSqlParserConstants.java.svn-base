...
public interface CCJSqlParserConstants {
  ...
  int K_ENGINE = 129;
  /** RegularExpression Id. */
  int K_AVG_ROW_LENGTH = 130;
  /** RegularExpression Id. */
  int K_CHECKSUM = 131;
  /** RegularExpression Id. */
  int K_CONNECTION = 132;
  /** RegularExpression Id. */
  int K_DATA = 133;
  /** RegularExpression Id. */
  int K_DIRECTORY = 134;
  /** RegularExpression Id. */
  int K_DELAY_KEY_WRITE = 135;
  /** RegularExpression Id. */
  int K_INSERT_METHOD = 136;
  /** RegularExpression Id. */
  int K_MAX_ROWS = 137;
  /** RegularExpression Id. */
  int K_MIN_ROWS = 138;
  ...
  int K_PASSWORD = 140;
  /** RegularExpression Id. */
  int K_ROW_FORMAT = 141;
  /** RegularExpression Id. */
  int K_DYNAMIC = 142;
  /** RegularExpression Id. */
  int K_COMPRESSED = 143;
  /** RegularExpression Id. */
  int K_REDUNDANT = 144;
  /** RegularExpression Id. */
  int K_COMPACT = 145;
  ...
  int K_TEXT = 186;
  /** RegularExpression Id. */
  int K_MEDIUMBLOB = 187;
  /** RegularExpression Id. */
  int K_MEDIUMTEXT = 188;
  /** RegularExpression Id. */
  int K_LONGBLOB = 189;
  /** RegularExpression Id. */
  int K_LONGTEXT = 190;
  ...
  int DIGIT = 199;
  /** RegularExpression Id. */
  int LINE_COMMENT = 200;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 201;
  /** RegularExpression Id. */
  int S_IDENTIFIER = 202;
  /** RegularExpression Id. */
  int LETTER = 203;
  /** RegularExpression Id. */
  int SPECIAL_CHARS = 204;
  /** RegularExpression Id. */
  int S_CHAR_LITERAL = 205;
  /** RegularExpression Id. */
  int S_OBJECT_NAME = 206;

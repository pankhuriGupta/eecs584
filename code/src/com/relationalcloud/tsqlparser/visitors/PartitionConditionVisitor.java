...
public class PartitionConditionVisitor implements ExpressionVisitor {

  private Column columnPartition = null;

  public Column getColumnFromPartitionCondition(Expression partitionCondition) {
  ...
  public void visit(Column partitionColumn) {
    this.columnPartition = partitionColumn;
  }

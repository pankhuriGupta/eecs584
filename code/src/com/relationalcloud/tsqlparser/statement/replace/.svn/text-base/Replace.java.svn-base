...
package com.relationalcloud.tsqlparser.statement.replace;
...
public class Replace implements Statement {
	...
	/**
	 * A list of {@link com.relationalcloud.tsqlparser.schema.Column}s either from a "REPLACE mytab (col1, col2) [...]" or a "REPLACE mytab SET col1=exp1, col2=exp2". 
	...
	/**
	 * A list of {@link com.relationalcloud.tsqlparser.expression.Expression}s (from a "REPLACE mytab SET col1=exp1, col2=exp2"). <br>
